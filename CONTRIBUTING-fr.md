...
👉 **[Guide du Flux de Travail de Création de Leçon](docs/guides/workflow-create-lesson.md)** ← Commencez ici!
...
**TL;DR**: Copier [modèle de leçon](docs/templates/lesson-template.md) → Écrire le contenu → Soumettre PR
...
1. **Lisez l'aperçu 10 minutes**: [Guide de Démarrage Rapide](docs/guides/quick-start.md)

2. **Choisissez votre approche**:
   - **Manuel**: Écrivez le vôtre en utilisant le [Modèle de Leçon](docs/templates/lesson-template.md)
   - **Généré par l'IA**: Utilisez le [Modèle d'Invite LLM](docs/templates/llm-prompt-template.txt) avec ChatGPT, Claude ou similaire
...
Consultez [Instructions du Modèle LLM](docs/guides/lesson-template-instructions.md) pour:
...
- [Flux de Travail de Création de Leçon](docs/guides/workflow-create-lesson.md) — Guide détaillé étape par étape
- [Modèle de Leçon](docs/templates/lesson-template.md) — Modèle à copier et utiliser
- [Instructions LLM](docs/guides/lesson-template-instructions.md) — Comment utiliser l'IA pour générer du contenu
- [Référence des Métadonnées](docs/guides/metadata-reference.md) — Spécifications complètes des champs
- [Guide de Marquage](docs/guides/tagging-guide.md) — Comment marquer les leçons
- [Référence des Tags](docs/guides/tags-reference.md) — Tags disponibles et leur utilisation
...
**Prêt à créer votre première leçon?** Commencez par le [Guide de Démarrage Rapide](docs/guides/quick-start.md)! 🚀
