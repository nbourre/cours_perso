...
👉 **[Lesson Creation Workflow Guide](docs/guides/workflow-create-lesson.md)** ← Start here!
...
**TL;DR**: Copy [lesson template](docs/templates/lesson-template.md) → Write content → Submit PR
...
1. **Read the 10-minute overview**: [Quick Start Guide](docs/guides/quick-start.md)

2. **Choose your approach**:
   - **Manual**: Write your own using the [Lesson Template](docs/templates/lesson-template.md)
   - **AI-Generated**: Use the [LLM Prompt Template](docs/templates/llm-prompt-template.txt) with ChatGPT, Claude, or similar
...
See [LLM Template Instructions](docs/guides/lesson-template-instructions.md) for:
...
- [Quick Start Guide](docs/guides/quick-start.md) — 10-minute overview
- [Lesson Creation Workflow](docs/guides/workflow-create-lesson.md) — Detailed step-by-step guide
- [Lesson Template](docs/templates/lesson-template.md) — Template to copy and use
- [LLM Instructions](docs/guides/lesson-template-instructions.md) — How to use AI to generate content
- [Metadata Reference](docs/guides/metadata-reference.md) — Complete field specifications
- [Tagging Guide](docs/guides/tagging-guide.md) — How to tag lessons
- [Tags Reference](docs/guides/tags-reference.md) — Available tags and their usage
...
**Ready to create your first lesson?** Start with the [Quick Start Guide](docs/guides/quick-start.md)! 🚀
