...
| What | Where | Link |
|------|-------|------|
| **Create a lesson** | Full workflow guide | [workflow-guide.md](./workflow-guide.md) |
| **Lesson structure** | Template contract | [lesson-template.md](./lesson-template.md) |
| **Metadata fields** | Specification | [metadata-spec.md](./metadata-spec.md) |
...
| **Implementation plan** | Details | [../plan.md](../plan.md) |
...
- ⚙️ **System Design** → Architecture, databases, scaling
...
- **Difficulty**: `beginner`, `intermediate`, `advanced` (also in metadata)
...
1. **Read the full [Workflow Guide](./workflow-guide.md)** for detailed instructions
2. **Copy the [Lesson Template](./lesson-template.md)** to start writing
...
- **Questions about structure?** → See [Lesson Template Contract](./lesson-template.md)
- **Questions about metadata?** → See [Metadata Specification](./metadata-spec.md)
- **Need detailed workflow?** → See [Lesson Creation Workflow Guide](./workflow-guide.md)
...
**Ready to create?** Start with the [Workflow Guide](./workflow-guide.md) or dive right in with the template! 🚀
