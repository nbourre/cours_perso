...
**Location**: `docs/guides/workflow-create-lesson.md` (linked from main README)
...
2. **Fill in metadata** (YAML frontmatter)
   ...
   - See [Metadata Specification](metadata-spec.md) for details

3. **Write content sections**
   - Learning Objectives, Introduction, Main Concepts, Examples, Exercises, Assessment
   - See [Lesson Template Contract](lesson-template.md) for full structure
...
1. **Read the [Lesson Template Contract](lesson-template.md)** for detailed structure
2. **Review the [Metadata Specification](metadata-spec.md)** for field details
3. **Choose your approach**: Write content or generate with LLM
4. **Create your lesson** using steps above
5. **Submit as a pull request** and wait for review
6. **Celebrate!** Your lesson is now part of the repository
